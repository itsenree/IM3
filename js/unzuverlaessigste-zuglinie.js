...
fetch("https://im3.enrico-fusaro.ch/php/unload/unzuverlässigste-zuglinie-aktuell.php?category=records")
    .then(response => response.json())
    .then(data => {
...
fetch("https://im3.enrico-fusaro.ch/php/unload/unzuverlässigste-zuglinie-aktuell.php?category=winners")
    .then(response => response.json())
    .then(data => {
